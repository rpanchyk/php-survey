<script type="text/javascript">
	function reloadImage(elem_id, elem_value) {
		img = document.getElementById(elem_id);
		img.src = elem_value + "?" + Math.random();
	}
</script>
	...
	?>
		...
		<tr>
		  <td valign="middle">
			  ...
			  <a href="#" onclick="reloadImage('aspamimg', '<?=$config['web_path']?>/antispam/antispam2.php'); return false;"><img src="<?=$config['web_path']?>/antispam/antispam2.php" name="aspamimg" width="80" height="21" id="aspamimg" style="border:0px solid; border-color:606060; vertical-align:bottom; padding-bottom:1px;" /></a></td>
		</tr>
